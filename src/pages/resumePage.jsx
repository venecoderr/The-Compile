...
export default function ResumePage() {
  return (
    ...
    <section className="container w-screen grid grid-cols-4">
      ...
      <section className="col-span-4 my-4 border-8 border-blue-950 rounded-lg">
        <section className="container grid grid-cols-2 md:grid-cols-4">
          ...
          <section className="cols-span-1 grid grid-cols-1 justify-items-center m-2">
            <img src={icons.express} alt="express icon" className="size-40  border-8 border-purple-500 rounded-full m-2"/>
            <p className="text-2xl text-center my-2">ExpressJs</p>
          </section>
          <section className="cols-span-1 grid grid-cols-1 justify-items-center m-2">
            <img src={icons.react} alt="react icon" className="size-40 border-8 border-cyan-400 rounded-full m-2"/>
            <p className="text-2xl text-center my-2">React</p>
          </section>
          <section className="cols-span-1 grid grid-cols-1 justify-items-center m-2">
            <img src={icons.node} alt="node icon" className="size-40 border-8 border-black rounded-full m-2"/>
            <p className="text-2xl text-center my-2">NodeJs</p>
          </section>
        </section>
        <h2 className="col-span-4 text-5xl text-center my-3">MERN STACK</h2>
      </section>
      <section className="grid grid-cols-2 md:grid-cols-4 col-span-4 my-4">
        <section className="cols-span-1 flex justify-evenly border-8 border-blue-950 rounded-full m-1">
        ...
        <section className="cols-span-1 flex justify-evenly border-8 border-blue-950 rounded-full m-1">
          ...
          <img src={icons.tailwind} alt="tailwind icon" className="size-12"/>
        </section>
        <section className="cols-span-1 flex justify-evenly border-8 border-blue-950 rounded-full m-1">
          <p className="text-2xl text-center my-2">Bootstrap</p>
          <img src={icons.bootstrap} alt="bootstrap icon" className="size-12"/>
        </section>
        <section className="cols-span-1 flex justify-evenly border-8 border-blue-950 rounded-full m-1">
          <p className="text-2xl text-center my-2">C-Sharp</p>
          <img src={icons.cSharp} alt="csharp icon" className="size-12"/>
        </section>
      </section>
